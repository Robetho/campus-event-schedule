            ...
            <div class="col-12">
                <div class="card">
                  <?php
                    ...
                    $check_info = mysqli_query($conn, "SELECT * FROM tbl_academic_session WHERE id = '$academic_id'");
                    $info = mysqli_fetch_assoc($check_info);
                  ?>
                <form class="form-horizontal" method="POST" action="processing/academic-settings">
                  <div class="card-body">
                    <h4 class="card-title">Edit Academic Info</h4>
                    ...
                    <div class="form-group row">
                      ...
                      >
                      <div class="col-sm-9">
                        <input type="text" class="form-control" value="<?= $info['academic_year']?>" name="academic-year" id="fname" placeholder="eg. 2025/2026" />
                      </div>
                    </div>
                    <div class="form-group row">
                      <label
                      ...
                      <div class="col-sm-9">
                        <select class="select2 form-select shadow-none mt-3" style="height: 36px; width: 100%;" name="semester">
                            ...
                            <option value="1" <?= isset($info['semester']) && $info['semester'] == '1'?'Selected':'' ?>>Semester 1</option>
                            <option value="2" <?= isset($info['semester']) && $info['semester'] == '2'?'Selected':'' ?>>Semester 2</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="border-top">
                    <div class="card-body">
                      <button type="submit" name="update-academic" class="btn btn-primary">
                        Save Data
                      </button>
                    </div>
                  </div>
