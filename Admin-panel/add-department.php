                ...
                <form class="form-horizontal" method="POST" action="processing/department-management">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      >
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="department-name" id="fname" placeholder="Enter department Name" />
                      </div>
                    </div>
                  </div>
                  <div class="border-top">
                    <div class="card-body">
                      <button type="submit" name="add-department" class="btn btn-primary">
                        Save Data
                      </button>
                    </div>
                  </div>
