      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
                <div class="card">
                <form class="form-horizontal" method="POST" action="processing/import-user-file" enctype="multipart/form-data">
                  <div class="card-body">
                    <h4 class="card-title">Import User File</h4>
                    <div class="form-group row">
                      <label
                        for="fname"
                        class="col-sm-3 text-end control-label col-form-label"
                        >Import File <span style="color: red;">(excel file) *</span></label
                      >
                      <div class="col-sm-9">
                  ...
                  <div class="border-top">
                    <div class="card-body">
                      <button type="submit" name="import-file" class="btn btn-primary">
                        Upload File
                      </button>
                    </div>
                  </div>
